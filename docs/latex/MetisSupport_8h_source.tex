...
\hypertarget{MetisSupport_8h_source}{}\label{MetisSupport_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/MetisSupport/MetisSupport.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/MetisSupport/MetisSupport.h}}
...
\DoxyCodeLine{00011\ }
\DoxyCodeLine{00012\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespaceEigen}{Eigen}}\ \{\textcolor{comment}{}}
\DoxyCodeLine{00013\ \textcolor{comment}{/**}}
\DoxyCodeLine{00014\ \textcolor{comment}{\ *\ Get\ the\ fill-\/reducing\ ordering\ from\ the\ METIS\ package}}
\DoxyCodeLine{00015\ \textcolor{comment}{\ *\ }}
\DoxyCodeLine{00016\ \textcolor{comment}{\ *\ If\ A\ is\ the\ original\ matrix\ and\ Ap\ is\ the\ permuted\ matrix,\ }}
\DoxyCodeLine{00017\ \textcolor{comment}{\ *\ the\ fill-\/reducing\ permutation\ is\ defined\ as\ follows\ :}}
\DoxyCodeLine{00018\ \textcolor{comment}{\ *\ Row\ (column)\ i\ of\ A\ is\ the\ matperm(i)\ row\ (column)\ of\ Ap.\ }}
\DoxyCodeLine{00019\ \textcolor{comment}{\ *\ WARNING:\ As\ computed\ by\ METIS,\ this\ corresponds\ to\ the\ vector\ iperm\ (instead\ of\ perm)}}
\DoxyCodeLine{00020\ \textcolor{comment}{\ */}}
\DoxyCodeLine{00021\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ StorageIndex>}
\DoxyCodeLine{00022\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classEigen_1_1MetisOrdering}{MetisOrdering}}}
\DoxyCodeLine{00023\ \{}
\DoxyCodeLine{00024\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00025\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classEigen_1_1PermutationMatrix}{PermutationMatrix<Dynamic,Dynamic,StorageIndex>}}\ PermutationType;}
\DoxyCodeLine{00026\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classEigen_1_1Matrix}{Matrix<StorageIndex,Dynamic,1>}}\ IndexVector;\ }
\DoxyCodeLine{00027\ \ \ }
\DoxyCodeLine{00028\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ MatrixType>}
\DoxyCodeLine{00029\ \ \ \textcolor{keywordtype}{void}\ get\_symmetrized\_graph(\textcolor{keyword}{const}\ \mbox{\hyperlink{classEigen_1_1Transform}{MatrixType}}\&\ A)}
\DoxyCodeLine{00030\ \ \ \{}
\DoxyCodeLine{00031\ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ m\ =\ A.cols();\ }
...
\DoxyCodeLine{00034\ \ \ \ \ \mbox{\hyperlink{classEigen_1_1Transform}{MatrixType}}\ At\ =\ A.transpose();\ }
\DoxyCodeLine{00035\ \ \ \ \ \textcolor{comment}{//\ Get\ the\ number\ of\ nonzeros\ elements\ in\ each\ row/col\ of\ At+A}}
\DoxyCodeLine{00036\ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ TotNz\ =\ 0;\ }
\DoxyCodeLine{00037\ \ \ \ \ IndexVector\ visited(m);\ }
\DoxyCodeLine{00038\ \ \ \ \ visited.\mbox{\hyperlink{classEigen_1_1PlainObjectBase_ac8dea1df3d92b752cc683ff42abf6f9b}{setConstant}}(-\/1);\ }
...
\DoxyCodeLine{00045\ \ \ \ \ \ \ \{}
\DoxyCodeLine{00046\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ idx\ =\ it.index();\ \textcolor{comment}{//\ Get\ the\ row\ index\ (for\ column\ major)\ or\ column\ index\ (for\ row\ major)}}
...
\DoxyCodeLine{00055\ \ \ \ \ \ \ \{}
\DoxyCodeLine{00056\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ idx\ =\ it.index();\ }
...
\DoxyCodeLine{00065\ \ \ \ \ m\_indexPtr.resize(m+1);}
\DoxyCodeLine{00066\ \ \ \ \ m\_innerIndices.resize(TotNz);\ }
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00068\ \ \ \ \ \textcolor{comment}{//\ Now\ compute\ the\ real\ adjacency\ list\ of\ each\ column/row\ }}
\DoxyCodeLine{00069\ \ \ \ \ visited.\mbox{\hyperlink{classEigen_1_1PlainObjectBase_ac8dea1df3d92b752cc683ff42abf6f9b}{setConstant}}(-\/1);\ }
...
\DoxyCodeLine{00103\ \ \ \textcolor{keywordtype}{void}\ operator()\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classEigen_1_1Transform}{MatrixType}}\&\ A,\ PermutationType\&\ matperm)}
\DoxyCodeLine{00104\ \ \ \{}
...
\DoxyCodeLine{00106\ \ \ \ \ \ IndexVector\ perm(m),iperm(m);\ }
...
\DoxyCodeLine{00112\ \ \ \ \ \ output\_error\ =\ METIS\_NodeND(\&m,\ m\_indexPtr.data(),\ m\_innerIndices.data(),\ NULL,\ NULL,\ perm.data(),\ iperm.\mbox{\hyperlink{classEigen_1_1PlainObjectBase_a322d4d48cc285b60e0dff100db522342}{data}}());}
\DoxyCodeLine{00113\ \ \ \ \ \ }
...
\DoxyCodeLine{00124\ \ \ \ \ }
\DoxyCodeLine{00125\ \ \ \ \ \ matperm.\mbox{\hyperlink{classEigen_1_1PermutationBase_a0e0fda6e84d69e02432e4770359bb532}{resize}}(m);}
\DoxyCodeLine{00126\ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ j\ =\ 0;\ j\ <\ m;\ j++)}
\DoxyCodeLine{00127\ \ \ \ \ \ \ \ matperm.\mbox{\hyperlink{classEigen_1_1PermutationMatrix_a9a2ae1608cc19e77e77863fce02f9066}{indices}}()(iperm(j))\ =\ j;}
\DoxyCodeLine{00128\ \ \ \ }
\DoxyCodeLine{00129\ \ \ \}}
\DoxyCodeLine{00130\ \ \ }
\DoxyCodeLine{00131\ \ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00132\ \ \ \ \ IndexVector\ m\_indexPtr;\ \textcolor{comment}{//\ Pointer\ to\ the\ adjacenccy\ list\ of\ each\ row/column}}
\DoxyCodeLine{00133\ \ \ \ \ IndexVector\ m\_innerIndices;\ \textcolor{comment}{//\ Adjacency\ list\ }}
\DoxyCodeLine{00134\ \};}
\DoxyCodeLine{00135\ }
