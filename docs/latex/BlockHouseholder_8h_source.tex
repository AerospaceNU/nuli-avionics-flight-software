...
\hypertarget{BlockHouseholder_8h_source}{}\label{BlockHouseholder_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/Householder/BlockHouseholder.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/Householder/BlockHouseholder.h}}
...
\DoxyCodeLine{00048\ \textcolor{comment}{/**\ \(\backslash\)internal\ */}}
...
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \ \ \textcolor{keywordflow}{for}(\mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ nbVecs-\/1;\ i\ >=0\ ;\ -\/-\/i)}
\DoxyCodeLine{00057\ \ \ \{}
\DoxyCodeLine{00058\ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ rs\ =\ vectors.rows()\ -\/\ i\ -\/\ 1;}
\DoxyCodeLine{00059\ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ rt\ =\ nbVecs-\/i-\/1;}
\DoxyCodeLine{00060\ }
...
\DoxyCodeLine{00068\ \ \ \ \ \ \ \textcolor{keywordflow}{for}(\mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=nbVecs-\/1;\ j>i;\ -\/-\/j)}
\DoxyCodeLine{00069\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00081\ \textcolor{comment}{/**\ \(\backslash\)internal}}
\DoxyCodeLine{00082\ \textcolor{comment}{\ \ *\ if\ forward\ then\ perform\ \ \ mat\ =\ H0\ *\ H1\ *\ H2\ *\ mat}}
\DoxyCodeLine{00083\ \textcolor{comment}{\ \ *\ otherwise\ perform\ \ \ \ \ \ \ \ \ mat\ =\ H2\ *\ H1\ *\ H0\ *\ mat}}
...
\DoxyCodeLine{00086\ \textcolor{keywordtype}{void}\ apply\_block\_householder\_on\_the\_left(\mbox{\hyperlink{structEigen_1_1internal_1_1traits}{MatrixType}}\&\ mat,\ \textcolor{keyword}{const}\ VectorsType\&\ vectors,\ \textcolor{keyword}{const}\ CoeffsType\&\ hCoeffs,\ \textcolor{keywordtype}{bool}\ forward)}
\DoxyCodeLine{00087\ \{}
...
\DoxyCodeLine{00099\ \ \ \ \ \ \ \ \ \ VectorsType::MaxColsAtCompileTime,\mbox{\hyperlink{structEigen_1_1internal_1_1traits}{MatrixType}}::MaxColsAtCompileTime>\ tmp\ =\ V.adjoint()\ *\ mat;}
