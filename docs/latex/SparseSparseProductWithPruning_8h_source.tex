...
\hypertarget{SparseSparseProductWithPruning_8h_source}{}\label{SparseSparseProductWithPruning_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseCore/SparseSparseProductWithPruning.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseCore/SparseSparseProductWithPruning.h}}
...
\DoxyCodeLine{00026\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1remove__all}{remove\_all<Lhs>::type::StorageIndex}}\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}};}
\DoxyCodeLine{00027\ }
...
\DoxyCodeLine{00063\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{evaluator<Rhs>::InnerIterator}}\ rhsIt(rhsEval,\ j);\ rhsIt;\ ++rhsIt)}
\DoxyCodeLine{00064\ \ \ \ \ \{}
...
\DoxyCodeLine{00068\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{evaluator<Lhs>::InnerIterator}}\ lhsIt(lhsEval,\ rhsIt.index());\ lhsIt;\ ++lhsIt)}
\DoxyCodeLine{00069\ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00081\ \ \ \textcolor{keywordtype}{int}\ LhsStorageOrder\ =\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{traits<Lhs>::Flags}}\&\mbox{\hyperlink{group__flags_gae4f56c2a60bbe4bd2e44c5b19cbe8762}{RowMajorBit}},}
\DoxyCodeLine{00082\ \ \ \textcolor{keywordtype}{int}\ RhsStorageOrder\ =\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{traits<Rhs>::Flags}}\&\mbox{\hyperlink{group__flags_gae4f56c2a60bbe4bd2e44c5b19cbe8762}{RowMajorBit}},}
\DoxyCodeLine{00083\ \ \ \textcolor{keywordtype}{int}\ ResStorageOrder\ =\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{traits<ResultType>::Flags}}\&\mbox{\hyperlink{group__flags_gae4f56c2a60bbe4bd2e44c5b19cbe8762}{RowMajorBit}}>}
...
\DoxyCodeLine{00092\ \ \ \{}
\DoxyCodeLine{00093\ \ \ \ \ \textcolor{keyword}{typename}\ remove\_all<ResultType>::type\ res\_(res.rows(),\ res.cols());}
\DoxyCodeLine{00094\ \ \ \ \ internal::sparse\_sparse\_product\_with\_pruning\_impl<Lhs,Rhs,ResultType>(lhs,\ rhs,\ res\_,\ tolerance);}
\DoxyCodeLine{00095\ \ \ \ \ res.swap(res\_);}
\DoxyCodeLine{00096\ \ \ \}}
\DoxyCodeLine{00097\ \};}
\DoxyCodeLine{00098\ }
...
\DoxyCodeLine{00107\ \ \ \ \ SparseTemporaryType\ res\_(res.rows(),\ res.cols());}
\DoxyCodeLine{00108\ \ \ \ \ internal::sparse\_sparse\_product\_with\_pruning\_impl<Lhs,Rhs,SparseTemporaryType>(lhs,\ rhs,\ res\_,\ tolerance);}
\DoxyCodeLine{00109\ \ \ \ \ res\ =\ res\_;}
\DoxyCodeLine{00110\ \ \ \}}
\DoxyCodeLine{00111\ \};}
\DoxyCodeLine{00112\ }
...
\DoxyCodeLine{00120\ \ \ \ \ \textcolor{keyword}{typename}\ remove\_all<ResultType>::type\ res\_(res.rows(),\ res.cols());}
\DoxyCodeLine{00121\ \ \ \ \ internal::sparse\_sparse\_product\_with\_pruning\_impl<Rhs,Lhs,ResultType>(rhs,\ lhs,\ res\_,\ tolerance);}
\DoxyCodeLine{00122\ \ \ \ \ res.swap(res\_);}
\DoxyCodeLine{00123\ \ \ \}}
\DoxyCodeLine{00124\ \};}
\DoxyCodeLine{00125\ }
...
\DoxyCodeLine{00140\ \textcolor{comment}{//\ \ \ \ \ SparseTemporaryType\ res\_(res.cols(),\ res.rows());}}
\DoxyCodeLine{00141\ \textcolor{comment}{//\ \ \ \ \ sparse\_sparse\_product\_with\_pruning\_impl<Rhs,Lhs,SparseTemporaryType>(rhs,\ lhs,\ res\_);}}
\DoxyCodeLine{00142\ \textcolor{comment}{//\ \ \ \ \ res\ =\ res\_.transpose();}}
\DoxyCodeLine{00143\ \ \ \}}
\DoxyCodeLine{00144\ \};}
\DoxyCodeLine{00145\ }
