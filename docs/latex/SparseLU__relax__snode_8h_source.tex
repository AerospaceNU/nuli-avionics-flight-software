...
\hypertarget{SparseLU__relax__snode_8h_source}{}\label{SparseLU__relax__snode_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseLU/SparseLU\_relax\_snode.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseLU/SparseLU\_relax\_snode.h}}
...
\DoxyCodeLine{00036\ \textcolor{comment}{\ *\ \(\backslash\)brief\ Identify\ the\ initial\ relaxed\ supernodes}}
\DoxyCodeLine{00037\ \textcolor{comment}{\ *\ }}
\DoxyCodeLine{00038\ \textcolor{comment}{\ *\ This\ routine\ is\ applied\ to\ a\ column\ elimination\ tree.\ }}
\DoxyCodeLine{00039\ \textcolor{comment}{\ *\ It\ assumes\ that\ the\ matrix\ has\ been\ reordered\ according\ to\ the\ postorder\ of\ the\ etree}}
\DoxyCodeLine{00040\ \textcolor{comment}{\ *\ \(\backslash\)param\ n\ \ the\ number\ of\ columns}}
\DoxyCodeLine{00041\ \textcolor{comment}{\ *\ \(\backslash\)param\ et\ elimination\ tree\ }}
\DoxyCodeLine{00042\ \textcolor{comment}{\ *\ \(\backslash\)param\ relax\_columns\ Maximum\ number\ of\ columns\ allowed\ in\ a\ relaxed\ snode\ }}
\DoxyCodeLine{00043\ \textcolor{comment}{\ *\ \(\backslash\)param\ descendants\ Number\ of\ descendants\ of\ each\ node\ in\ the\ etree}}
\DoxyCodeLine{00044\ \textcolor{comment}{\ *\ \(\backslash\)param\ relax\_end\ last\ column\ in\ a\ supernode}}
...
\DoxyCodeLine{00047\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classEigen_1_1internal_1_1SparseLUImpl_a33672df380f94e774c5a6919d3474af4}{SparseLUImpl<Scalar,StorageIndex>::relax\_snode}}\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n,\ IndexVector\&\ et,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ relax\_columns,\ IndexVector\&\ descendants,\ IndexVector\&\ relax\_end)}
\DoxyCodeLine{00048\ \{}
\DoxyCodeLine{00049\ \ \ }
...
\DoxyCodeLine{00052\ \ \ relax\_end.\mbox{\hyperlink{classEigen_1_1PlainObjectBase_ac8dea1df3d92b752cc683ff42abf6f9b}{setConstant}}(emptyIdxLU);}
\DoxyCodeLine{00053\ \ \ descendants.\mbox{\hyperlink{classEigen_1_1PlainObjectBase_ac21ad5f989f320e46958b75ac8d9a1da}{setZero}}();}
\DoxyCodeLine{00054\ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ 0;\ j\ <\ n;\ j++)\ }
\DoxyCodeLine{00055\ \ \ \{}
...
\DoxyCodeLine{00062\ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ 0;\ j\ <\ n;\ )}
\DoxyCodeLine{00063\ \ \ \{}
...
\DoxyCodeLine{00072\ \ \ \ \ relax\_end(snode\_start)\ =\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}(j);\ \textcolor{comment}{//\ Record\ last\ column}}
