...
\hypertarget{Parallelizer_8h_source}{}\label{Parallelizer_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/Core/products/Parallelizer.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/Core/products/Parallelizer.h}}
...
\DoxyCodeLine{00022\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ manage\_multi\_threading(Action\ action,\ \textcolor{keywordtype}{int}*\ v)}
\DoxyCodeLine{00023\ \{}
\DoxyCodeLine{00024\ \ \ \textcolor{keyword}{static}\ \textcolor{keywordtype}{int}\ m\_maxThreads\ =\ -\/1;}
\DoxyCodeLine{00025\ \ \ EIGEN\_UNUSED\_VARIABLE(m\_maxThreads)}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \ \ \textcolor{keywordflow}{if}(action==SetAction)}
\DoxyCodeLine{00028\ \ \ \{}
\DoxyCodeLine{00029\ \ \ \ \ eigen\_internal\_assert(v!=0);}
\DoxyCodeLine{00030\ \ \ \ \ m\_maxThreads\ =\ *v;}
\DoxyCodeLine{00031\ \ \ \}}
\DoxyCodeLine{00032\ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}(action==GetAction)}
\DoxyCodeLine{00033\ \ \ \{}
\DoxyCodeLine{00034\ \ \ \ \ eigen\_internal\_assert(v!=0);}
...
\DoxyCodeLine{00045\ \ \ \{}
\DoxyCodeLine{00046\ \ \ \ \ eigen\_internal\_assert(\textcolor{keyword}{false});}
\DoxyCodeLine{00047\ \ \ \}}
\DoxyCodeLine{00048\ \}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ \}}
\DoxyCodeLine{00051\ \textcolor{comment}{}}
\DoxyCodeLine{00052\ \textcolor{comment}{/**\ Must\ be\ call\ first\ when\ calling\ Eigen\ from\ multiple\ threads\ */}}
...
\DoxyCodeLine{00056\ \ \ internal::manage\_multi\_threading(GetAction,\ \&nbt);}
\DoxyCodeLine{00057\ \ \ std::ptrdiff\_t\ l1,\ l2,\ l3;}
\DoxyCodeLine{00058\ \ \ internal::manage\_caching\_sizes(GetAction,\ \&l1,\ \&l2,\ \&l3);}
\DoxyCodeLine{00059\ \}}
\DoxyCodeLine{00060\ \textcolor{comment}{}}
\DoxyCodeLine{00061\ \textcolor{comment}{/**\ \(\backslash\)returns\ the\ max\ number\ of\ threads\ reserved\ for\ Eigen}}
\DoxyCodeLine{00062\ \textcolor{comment}{\ \ *\ \(\backslash\)sa\ setNbThreads\ */}}
...
\DoxyCodeLine{00066\ \ \ internal::manage\_multi\_threading(GetAction,\ \&ret);}
\DoxyCodeLine{00067\ \ \ \textcolor{keywordflow}{return}\ ret;}
\DoxyCodeLine{00068\ \}}
\DoxyCodeLine{00069\ \textcolor{comment}{}}
\DoxyCodeLine{00070\ \textcolor{comment}{/**\ Sets\ the\ max\ number\ of\ threads\ reserved\ for\ Eigen}}
\DoxyCodeLine{00071\ \textcolor{comment}{\ \ *\ \(\backslash\)sa\ nbThreads\ */}}
...
\DoxyCodeLine{00073\ \{}
\DoxyCodeLine{00074\ \ \ internal::manage\_multi\_threading(SetAction,\ \&v);}
\DoxyCodeLine{00075\ \}}
\DoxyCodeLine{00076\ }
...
\DoxyCodeLine{00080\ \{}
\DoxyCodeLine{00081\ \ \ GemmParallelInfo()\ :\ sync(-\/1),\ users(0),\ lhs\_start(0),\ lhs\_length(0)\ \{\}}
\DoxyCodeLine{00082\ }
...
\DoxyCodeLine{00088\ \ \ std::atomic<Index>\ sync;}
\DoxyCodeLine{00089\ \ \ std::atomic<int>\ users;}
\DoxyCodeLine{00090\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00091\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \textcolor{keyword}{volatile}\ sync;}
\DoxyCodeLine{00092\ \ \ \textcolor{keywordtype}{int}\ \textcolor{keyword}{volatile}\ users;}
\DoxyCodeLine{00093\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00095\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lhs\_start;}
\DoxyCodeLine{00096\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ lhs\_length;}
\DoxyCodeLine{00097\ \};}
\DoxyCodeLine{00098\ }
...
\DoxyCodeLine{00112\ \ \ EIGEN\_UNUSED\_VARIABLE(depth);}
\DoxyCodeLine{00113\ \ \ EIGEN\_UNUSED\_VARIABLE(transpose);}
...
\DoxyCodeLine{00125\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ size\ =\ transpose\ ?\ rows\ :\ cols;}
\DoxyCodeLine{00126\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ pb\_max\_threads\ =\ std::max<Index>(1,size\ /\ Functor::Traits::nr);}
\DoxyCodeLine{00127\ }
...
\DoxyCodeLine{00148\ }
\DoxyCodeLine{00149\ \ \ ei\_declare\_aligned\_stack\_constructed\_variable(\mbox{\hyperlink{structEigen_1_1internal_1_1GemmParallelInfo}{GemmParallelInfo<Index>}},info,threads,0);}
\DoxyCodeLine{00150\ }
\DoxyCodeLine{00151\ \textcolor{preprocessor}{\ \ \#pragma\ omp\ parallel\ num\_threads(threads)}}
\DoxyCodeLine{00152\ \ \ \{}
\DoxyCodeLine{00153\ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ omp\_get\_thread\_num();}
...
\DoxyCodeLine{00160\ }
\DoxyCodeLine{00161\ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ r0\ =\ i*blockRows;}
\DoxyCodeLine{00162\ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ actualBlockRows\ =\ (i+1==actual\_threads)\ ?\ rows-\/r0\ :\ blockRows;}
\DoxyCodeLine{00163\ }
\DoxyCodeLine{00164\ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ c0\ =\ i*blockCols;}
\DoxyCodeLine{00165\ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ actualBlockCols\ =\ (i+1==actual\_threads)\ ?\ cols-\/c0\ :\ blockCols;}
\DoxyCodeLine{00166\ }
\DoxyCodeLine{00167\ \ \ \ \ info[i].lhs\_start\ =\ r0;}
\DoxyCodeLine{00168\ \ \ \ \ info[i].lhs\_length\ =\ actualBlockRows;}
\DoxyCodeLine{00169\ }
