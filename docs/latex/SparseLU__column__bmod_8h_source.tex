...
\hypertarget{SparseLU__column__bmod_8h_source}{}\label{SparseLU__column__bmod_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseLU/SparseLU\_column\_bmod.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseLU/SparseLU\_column\_bmod.h}}
...
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{keyword}{namespace\ }internal\ \{\textcolor{comment}{}}
\DoxyCodeLine{00037\ \textcolor{comment}{/**}}
\DoxyCodeLine{00038\ \textcolor{comment}{\ *\ \(\backslash\)brief\ Performs\ numeric\ block\ updates\ (sup-\/col)\ in\ topological\ order}}
\DoxyCodeLine{00039\ \textcolor{comment}{\ *\ }}
\DoxyCodeLine{00040\ \textcolor{comment}{\ *\ \(\backslash\)param\ jcol\ current\ column\ to\ update}}
\DoxyCodeLine{00041\ \textcolor{comment}{\ *\ \(\backslash\)param\ nseg\ Number\ of\ segments\ in\ the\ U\ part}}
\DoxyCodeLine{00042\ \textcolor{comment}{\ *\ \(\backslash\)param\ dense\ Store\ the\ full\ representation\ of\ the\ column}}
\DoxyCodeLine{00043\ \textcolor{comment}{\ *\ \(\backslash\)param\ tempv\ working\ array\ }}
\DoxyCodeLine{00044\ \textcolor{comment}{\ *\ \(\backslash\)param\ segrep\ segment\ representative\ ...}}
\DoxyCodeLine{00045\ \textcolor{comment}{\ *\ \(\backslash\)param\ repfnz\ ???\ First\ nonzero\ column\ in\ each\ row\ ???\ \ ...}}
\DoxyCodeLine{00046\ \textcolor{comment}{\ *\ \(\backslash\)param\ fpanelc\ First\ column\ in\ the\ current\ panel}}
\DoxyCodeLine{00047\ \textcolor{comment}{\ *\ \(\backslash\)param\ glu\ Global\ LU\ data.\ }}
\DoxyCodeLine{00048\ \textcolor{comment}{\ *\ \(\backslash\)return\ 0\ -\/\ successful\ return\ }}
\DoxyCodeLine{00049\ \textcolor{comment}{\ *\ \ \ \ \ \ \ \ \ >\ 0\ -\/\ number\ of\ bytes\ allocated\ when\ run\ out\ of\ space}}
...
\DoxyCodeLine{00053\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \mbox{\hyperlink{classEigen_1_1internal_1_1SparseLUImpl_ae34275602cf12560edfcaf7cd5cbe932}{SparseLUImpl<Scalar,StorageIndex>::column\_bmod}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ jcol,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nseg,\ BlockScalarVector\ dense,\ ScalarVector\&\ tempv,}
...
\DoxyCodeLine{00106\ \ \ \ \ \ \ \ \ LU\_kernel\_bmod<1>::run(segsize,\ dense,\ tempv,\ glu.lusup,\ luptr,\ lda,\ nrow,\ glu.lsub,\ lptr,\ no\_zeros);}
\DoxyCodeLine{00107\ \ \ \ \ \ \ \textcolor{keywordflow}{else}}
\DoxyCodeLine{00108\ \ \ \ \ \ \ \ \ LU\_kernel\_bmod<Dynamic>::run(segsize,\ dense,\ tempv,\ glu.lusup,\ luptr,\ lda,\ nrow,\ glu.lsub,\ lptr,\ no\_zeros);}
...
\DoxyCodeLine{00119\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ offset\ =\ internal::first\_multiple<Index>(new\_next,\ internal::packet\_traits<Scalar>::size)\ -\/\ new\_next;}
...
\DoxyCodeLine{00123\ \ \ \{}
\DoxyCodeLine{00124\ \ \ \ \ mem\ =\ \mbox{\hyperlink{classEigen_1_1internal_1_1SparseLUImpl_a2a6465f1173fd8b74b2e5b8ceec53343}{memXpand<ScalarVector>}}(glu.lusup,\ glu.nzlumax,\ nextlu,\ LUSUP,\ glu.num\_expansions);\ \ }
...
\DoxyCodeLine{00132\ \ \ \ \ dense(irow)\ =\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{Scalar}}(0.0);\ }
...
\DoxyCodeLine{00140\ \ \ \}}
\DoxyCodeLine{00141\ \ \ glu.xlusup(jcol\ +\ 1)\ =\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}(nextlu);\ \ \textcolor{comment}{//\ close\ L\(\backslash\)U(*,jcol);\ }}
\DoxyCodeLine{00142\ \ \ }
...
\DoxyCodeLine{00166\ \ \ \ \ MappedMatrixBlock\ A(\ \&(glu.lusup.data()[luptr]),\ nsupc,\ nsupc,\ \mbox{\hyperlink{classEigen_1_1OuterStride}{OuterStride<>}}(lda)\ );}
\DoxyCodeLine{00167\ \ \ \ \ \mbox{\hyperlink{classEigen_1_1VectorBlock}{VectorBlock<ScalarVector>}}\ u(glu.lusup,\ ufirst,\ nsupc);\ }
\DoxyCodeLine{00168\ \ \ \ \ u\ =\ A.template\ triangularView<UnitLower>().solve(u);\ }
\DoxyCodeLine{00169\ \ \ \ \ }
\DoxyCodeLine{00170\ \ \ \ \ \textcolor{keyword}{new}\ (\&A)\ MappedMatrixBlock\ (\ \&(glu.lusup.data()[luptr+nsupc]),\ nrow,\ nsupc,\ \mbox{\hyperlink{classEigen_1_1OuterStride}{OuterStride<>}}(lda)\ );}
\DoxyCodeLine{00171\ \ \ \ \ \mbox{\hyperlink{classEigen_1_1VectorBlock}{VectorBlock<ScalarVector>}}\ l(glu.lusup,\ ufirst+nsupc,\ nrow);\ }
