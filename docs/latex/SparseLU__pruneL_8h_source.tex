...
\hypertarget{SparseLU__pruneL_8h_source}{}\label{SparseLU__pruneL_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseLU/SparseLU\_pruneL.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseLU/SparseLU\_pruneL.h}}
...
\DoxyCodeLine{00037\ \textcolor{comment}{\ *\ \(\backslash\)brief\ Prunes\ the\ L-\/structure.}}
\DoxyCodeLine{00038\ \textcolor{comment}{\ *}}
\DoxyCodeLine{00039\ \textcolor{comment}{\ *\ It\ prunes\ the\ L-\/structure\ \ of\ supernodes\ whose\ L-\/structure\ contains\ the\ current\ pivot\ row\ "{}pivrow"{}}}
\DoxyCodeLine{00040\ \textcolor{comment}{\ *\ }}
\DoxyCodeLine{00041\ \textcolor{comment}{\ *\ }}
\DoxyCodeLine{00042\ \textcolor{comment}{\ *\ \(\backslash\)param\ jcol\ The\ current\ column\ of\ L}}
\DoxyCodeLine{00043\ \textcolor{comment}{\ *\ \(\backslash\)param[in]\ perm\_r\ Row\ permutation}}
\DoxyCodeLine{00044\ \textcolor{comment}{\ *\ \(\backslash\)param[out]\ pivrow\ \ The\ pivot\ row}}
\DoxyCodeLine{00045\ \textcolor{comment}{\ *\ \(\backslash\)param\ nseg\ Number\ of\ segments}}
\DoxyCodeLine{00046\ \textcolor{comment}{\ *\ \(\backslash\)param\ segrep\ }}
\DoxyCodeLine{00047\ \textcolor{comment}{\ *\ \(\backslash\)param\ repfnz}}
\DoxyCodeLine{00048\ \textcolor{comment}{\ *\ \(\backslash\)param[out]\ xprune\ }}
\DoxyCodeLine{00049\ \textcolor{comment}{\ *\ \(\backslash\)param\ glu\ Global\ LU\ data}}
...
\DoxyCodeLine{00053\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classEigen_1_1internal_1_1SparseLUImpl_a350464d1c83182fbd7da8a5a74bdfde8}{SparseLUImpl<Scalar,StorageIndex>::pruneL}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ jcol,\ \textcolor{keyword}{const}\ IndexVector\&\ perm\_r,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ pivrow,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nseg,}
\DoxyCodeLine{00054\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ IndexVector\&\ segrep,\ BlockIndexVector\ repfnz,\ IndexVector\&\ xprune,\ GlobalLU\_t\&\ glu)}
\DoxyCodeLine{00055\ \{}
\DoxyCodeLine{00056\ \ \ \textcolor{comment}{//\ For\ each\ supernode-\/rep\ irep\ in\ U(*,j]}}
\DoxyCodeLine{00057\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ jsupno\ =\ glu.supno(jcol);\ }
\DoxyCodeLine{00058\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i,irep,irep1;\ }
...
\DoxyCodeLine{00126\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00127\ \ \ \ \ \ \ \ \ xprune(irep)\ =\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}(kmin);\ \ \textcolor{comment}{//Pruning\ }}
