...
\hypertarget{SparseColEtree_8h_source}{}\label{SparseColEtree_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseCore/SparseColEtree.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseCore/SparseColEtree.h}}
...
\DoxyCodeLine{00038\ \textcolor{comment}{/**\ Find\ the\ root\ of\ the\ tree/set\ containing\ the\ vertex\ i\ :\ Use\ Path\ halving\ */}\ }
\DoxyCodeLine{00039\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Index,\ \textcolor{keyword}{typename}\ IndexVector>}
\DoxyCodeLine{00040\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ etree\_find\ (\mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i,\ IndexVector\&\ pp)}
\DoxyCodeLine{00041\ \{}
\DoxyCodeLine{00042\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ p\ =\ pp(i);\ \textcolor{comment}{//\ Parent\ }}
...
\DoxyCodeLine{00054\ \textcolor{comment}{/**\ Compute\ the\ column\ elimination\ tree\ of\ a\ sparse\ matrix}}
\DoxyCodeLine{00055\ \textcolor{comment}{\ \ *\ \(\backslash\)param\ mat\ The\ matrix\ in\ column-\/major\ format.\ }}
\DoxyCodeLine{00056\ \textcolor{comment}{\ \ *\ \(\backslash\)param\ parent\ The\ elimination\ tree}}
\DoxyCodeLine{00057\ \textcolor{comment}{\ \ *\ \(\backslash\)param\ firstRowElt\ The\ column\ index\ of\ the\ first\ element\ in\ each\ row}}
\DoxyCodeLine{00058\ \textcolor{comment}{\ \ *\ \(\backslash\)param\ perm\ The\ permutation\ to\ apply\ to\ the\ column\ of\ \(\backslash\)b\ mat}}
...
\DoxyCodeLine{00061\ \textcolor{keywordtype}{int}\ coletree(\textcolor{keyword}{const}\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{MatrixType}}\&\ mat,\ IndexVector\&\ parent,\ IndexVector\&\ firstRowElt,\ \textcolor{keyword}{typename}\ MatrixType::StorageIndex\ *perm=0)}
\DoxyCodeLine{00062\ \{}
\DoxyCodeLine{00063\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ MatrixType::StorageIndex\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}};}
\DoxyCodeLine{00064\ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ nc\ =\ convert\_index<StorageIndex>(mat.cols());\ \textcolor{comment}{//\ Number\ of\ columns}}
\DoxyCodeLine{00065\ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ m\ =\ convert\_index<StorageIndex>(mat.rows());}
\DoxyCodeLine{00066\ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ diagSize\ =\ (std::min)(nc,m);}
...
\DoxyCodeLine{00077\ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ col\ =\ 0;\ col\ <\ nc;\ col++)}
\DoxyCodeLine{00078\ \ \ \{}
\DoxyCodeLine{00079\ \ \ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ pcol\ =\ col;}
...
\DoxyCodeLine{00082\ \ \ \ \ \{\ }
\DoxyCodeLine{00083\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ row\ =\ it.row();}
...
\DoxyCodeLine{00091\ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ rset,\ cset,\ rroot;}
\DoxyCodeLine{00092\ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ col\ =\ 0;\ col\ <\ nc;\ col++)\ }
\DoxyCodeLine{00093\ \ \ \{}
...
\DoxyCodeLine{00101\ \ \ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ pcol\ =\ col;}
...
\DoxyCodeLine{00105\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ col;}
...
\DoxyCodeLine{00108\ \ \ \ \ \ \ }
\DoxyCodeLine{00109\ \ \ \ \ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ row\ =\ firstRowElt(i);}
...
\DoxyCodeLine{00126\ \textcolor{comment}{\ \ *\ Depth-\/first\ search\ from\ vertex\ n.\ \ No\ recursion.}}
\DoxyCodeLine{00127\ \textcolor{comment}{\ \ *\ This\ routine\ was\ contributed\ by\ Cédric\ Doucet,\ CEDRAT\ Group,\ Meylan,\ France.}}
...
\DoxyCodeLine{00131\ \{}
\DoxyCodeLine{00132\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ IndexVector::Scalar\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}};}
\DoxyCodeLine{00133\ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ current\ =\ n,\ first,\ next;}
...
\DoxyCodeLine{00172\ \textcolor{comment}{\ \ *\ \(\backslash\)brief\ Post\ order\ a\ tree\ }}
\DoxyCodeLine{00173\ \textcolor{comment}{\ \ *\ \(\backslash\)param\ n\ the\ number\ of\ nodes}}
\DoxyCodeLine{00174\ \textcolor{comment}{\ \ *\ \(\backslash\)param\ parent\ Input\ tree}}
\DoxyCodeLine{00175\ \textcolor{comment}{\ \ *\ \(\backslash\)param\ post\ postordered\ tree}}
...
\DoxyCodeLine{00179\ \{}
\DoxyCodeLine{00180\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ IndexVector::Scalar\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}};}
\DoxyCodeLine{00181\ \ \ IndexVector\ first\_kid,\ next\_kid;\ \textcolor{comment}{//\ Linked\ list\ of\ children\ }}
\DoxyCodeLine{00182\ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ postnum;\ }
...
\DoxyCodeLine{00190\ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ v\ =\ n-\/1;\ v\ >=\ 0;\ v-\/-\/)\ }
\DoxyCodeLine{00191\ \ \ \{}
\DoxyCodeLine{00192\ \ \ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{StorageIndex}}\ dad\ =\ parent(v);}
