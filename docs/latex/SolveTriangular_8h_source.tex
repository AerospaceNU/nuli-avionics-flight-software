...
\hypertarget{SolveTriangular_8h_source}{}\label{SolveTriangular_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/Core/SolveTriangular.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/Core/SolveTriangular.h}}
...
\DoxyCodeLine{00035\ \ \ \ \ \ \ Unrolling\ \ \ =\ (RhsIsVectorAtCompileTime\ \&\&\ Rhs::SizeAtCompileTime\ !=\ \mbox{\hyperlink{namespaceEigen_ad81fa7195215a0ce30017dfac309f0b2}{Dynamic}}\ \&\&\ Rhs::SizeAtCompileTime\ <=\ 8)}
\DoxyCodeLine{00036\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ?\ CompleteUnrolling\ :\ NoUnrolling,}
\DoxyCodeLine{00037\ \ \ \ \ \ \ RhsVectors\ \ =\ RhsIsVectorAtCompileTime\ ?\ 1\ :\ \mbox{\hyperlink{namespaceEigen_ad81fa7195215a0ce30017dfac309f0b2}{Dynamic}}}
\DoxyCodeLine{00038\ \ \ \ \ \};}
\DoxyCodeLine{00039\ \};}
\DoxyCodeLine{00040\ }
...
\DoxyCodeLine{00050\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solver__selector}{triangular\_solver\_selector}}<Lhs,Rhs,Side,Mode,NoUnrolling,1>}
\DoxyCodeLine{00051\ \{}
...
\DoxyCodeLine{00054\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{structEigen_1_1internal_1_1blas__traits}{blas\_traits<Lhs>}}\ LhsProductTraits;}
\DoxyCodeLine{00055\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ LhsProductTraits::ExtractType\ ActualLhsType;}
\DoxyCodeLine{00056\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classEigen_1_1Map}{Map<Matrix<RhsScalar,Dynamic,1>}},\ \mbox{\hyperlink{group__enums_gga45fe06e29902b7a2773de05ba27b47a1ae12d0f8f869c40c76128260af2242bc8}{Aligned}}>\ MappedRhs;}
...
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00071\ \ \ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solve__vector}{triangular\_solve\_vector}}<LhsScalar,\ RhsScalar,\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}},\ Side,\ Mode,\ LhsProductTraits::NeedToConjugate,}
...
\DoxyCodeLine{00082\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solver__selector}{triangular\_solver\_selector}}<Lhs,Rhs,Side,Mode,NoUnrolling,\mbox{\hyperlink{namespaceEigen_ad81fa7195215a0ce30017dfac309f0b2}{Dynamic}}>}
\DoxyCodeLine{00083\ \{}
\DoxyCodeLine{00084\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ Rhs::Scalar\ Scalar;}
\DoxyCodeLine{00085\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{structEigen_1_1internal_1_1blas__traits}{blas\_traits<Lhs>}}\ LhsProductTraits;}
...
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00092\ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ size\ =\ lhs.rows();}
...
\DoxyCodeLine{00115\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solver__unroller}{triangular\_solver\_unroller}}<Lhs,Rhs,Mode,LoopIndex,Size,false>\ \{}
...
\DoxyCodeLine{00135\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solver__unroller}{triangular\_solver\_unroller}}<Lhs,Rhs,Mode,LoopIndex,Size,true>\ \{}
...
\DoxyCodeLine{00140\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solver__selector}{triangular\_solver\_selector}}<Lhs,Rhs,\mbox{\hyperlink{group__enums_ggac22de43beeac7a78b384f99bed5cee0ba21b30a61e9cb10c967aec17567804007}{OnTheLeft}},Mode,CompleteUnrolling,1>\ \{}
...
\DoxyCodeLine{00146\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solver__selector}{triangular\_solver\_selector}}<Lhs,Rhs,\mbox{\hyperlink{group__enums_ggac22de43beeac7a78b384f99bed5cee0ba329fc3a54ceb2b6e0e73b400998b8a82}{OnTheRight}},Mode,CompleteUnrolling,1>\ \{}
...
\DoxyCodeLine{00167\ EIGEN\_DEVICE\_FUNC\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classEigen_1_1TriangularViewImpl}{TriangularViewImpl<MatrixType,Mode,Dense>::solveInPlace}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classEigen_1_1MatrixBase}{MatrixBase<OtherDerived>}}\&\ \_other)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00175\ }
\DoxyCodeLine{00176\ \ \ \textcolor{keyword}{enum}\ \{\ copy\ =\ (\mbox{\hyperlink{structEigen_1_1internal_1_1traits}{internal::traits<OtherDerived>::Flags}}\ \&\ \mbox{\hyperlink{group__flags_gae4f56c2a60bbe4bd2e44c5b19cbe8762}{RowMajorBit}})\ \ \&\&\ OtherDerived::IsVectorAtCompileTime\ \&\&\ OtherDerived::SizeAtCompileTime!=1\};}
\DoxyCodeLine{00177\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ internal::conditional<copy,}
\DoxyCodeLine{00178\ \ \ \ \ \textcolor{keyword}{typename}\ internal::plain\_matrix\_type\_column\_major<OtherDerived>::type,\ OtherDerived\&>::type\ OtherCopy;}
...
\DoxyCodeLine{00190\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solve__retval}{internal::triangular\_solve\_retval<Side,TriangularView<Derived,Mode>}},Other>}
\DoxyCodeLine{00191\ \mbox{\hyperlink{classEigen_1_1TriangularViewImpl}{TriangularViewImpl<Derived,Mode,Dense>::solve}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classEigen_1_1MatrixBase}{MatrixBase<Other>}}\&\ other)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00192\ \textcolor{keyword}{}\{}
\DoxyCodeLine{00193\ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solve__retval}{internal::triangular\_solve\_retval<Side,TriangularViewType,Other>}}(derived(),\ other.derived());}
\DoxyCodeLine{00194\ \}}
...
\DoxyCodeLine{00201\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structEigen_1_1internal_1_1traits}{traits}}<\mbox{\hyperlink{structEigen_1_1internal_1_1triangular__solve__retval}{triangular\_solve\_retval}}<Side,\ TriangularType,\ Rhs>\ >}
\DoxyCodeLine{00202\ \{}
...
\DoxyCodeLine{00210\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classEigen_1_1ReturnByValue}{ReturnByValue<triangular\_solve\_retval>}}\ Base;}
\DoxyCodeLine{00211\ }
...
\DoxyCodeLine{00214\ \ \ \{\}}
\DoxyCodeLine{00215\ }
\DoxyCodeLine{00216\ \ \ \textcolor{keyword}{inline}\ EIGEN\_CONSTEXPR\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ rows()\ \textcolor{keyword}{const}\ EIGEN\_NOEXCEPT\ \{\ \textcolor{keywordflow}{return}\ m\_rhs.rows();\ \}}
\DoxyCodeLine{00217\ \ \ \textcolor{keyword}{inline}\ EIGEN\_CONSTEXPR\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ cols()\ \textcolor{keyword}{const}\ EIGEN\_NOEXCEPT\ \{\ \textcolor{keywordflow}{return}\ m\_rhs.cols();\ \}}
\DoxyCodeLine{00218\ }
