...
\hypertarget{SparseDot_8h_source}{}\label{SparseDot_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseCore/SparseDot.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseCore/SparseDot.h}}
...
\DoxyCodeLine{00017\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{internal::traits<Derived>::Scalar}}}
\DoxyCodeLine{00018\ SparseMatrixBase<Derived>::dot(\textcolor{keyword}{const}\ \mbox{\hyperlink{classEigen_1_1MatrixBase}{MatrixBase<OtherDerived>}}\&\ other)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{internal::evaluator<Derived>}}\ thisEval(derived());}
\DoxyCodeLine{00030\ \ \ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{internal::evaluator<Derived>::InnerIterator}}\ i(thisEval,\ 0);}
\DoxyCodeLine{00031\ \ \ \mbox{\hyperlink{classEigen_1_1Product}{Scalar}}\ res(0);}
...
\DoxyCodeLine{00042\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{internal::traits<Derived>::Scalar}}}
\DoxyCodeLine{00043\ SparseMatrixBase<Derived>::dot(\textcolor{keyword}{const}\ \mbox{\hyperlink{classEigen_1_1SparseMatrixBase}{SparseMatrixBase<OtherDerived>}}\&\ other)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00052\ }
\DoxyCodeLine{00053\ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{internal::evaluator<Derived>}}\ thisEval(derived());}
\DoxyCodeLine{00054\ \ \ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{internal::evaluator<Derived>::InnerIterator}}\ i(thisEval,\ 0);}
\DoxyCodeLine{00055\ \ \ }
\DoxyCodeLine{00056\ \ \ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{internal::evaluator<OtherDerived>}}\ \ otherEval(other.derived());}
\DoxyCodeLine{00057\ \ \ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{internal::evaluator<OtherDerived>::InnerIterator}}\ j(otherEval,\ 0);}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \ \ \mbox{\hyperlink{classEigen_1_1Product}{Scalar}}\ res(0);}
...
\DoxyCodeLine{00076\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1NumTraits}{NumTraits<typename\ internal::traits<Derived>::Scalar}}>::Real}
...
\DoxyCodeLine{00083\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1NumTraits}{NumTraits<typename\ internal::traits<Derived>::Scalar}}>::Real}
...
\DoxyCodeLine{00091\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1NumTraits}{NumTraits<typename\ internal::traits<Derived>::Scalar}}>::Real}
