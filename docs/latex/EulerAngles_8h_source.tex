...
\hypertarget{EulerAngles_8h_source}{}\label{EulerAngles_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/Geometry/EulerAngles.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/Geometry/EulerAngles.h}}
...
\DoxyCodeLine{00018\ \textcolor{comment}{\ \ *\ \(\backslash\)returns\ the\ Euler-\/angles\ of\ the\ rotation\ matrix\ \(\backslash\)c\ *this\ using\ the\ convention\ defined\ by\ the\ triplet\ (\(\backslash\)a\ a0,\(\backslash\)a\ a1,\(\backslash\)a\ a2)}}
\DoxyCodeLine{00019\ \textcolor{comment}{\ \ *}}
\DoxyCodeLine{00020\ \textcolor{comment}{\ \ *\ Each\ of\ the\ three\ parameters\ \(\backslash\)a\ a0,\(\backslash\)a\ a1,\(\backslash\)a\ a2\ represents\ the\ respective\ rotation\ axis\ as\ an\ integer\ in\ \{0,1,2\}.}}
\DoxyCodeLine{00021\ \textcolor{comment}{\ \ *\ For\ instance,\ in:}}
\DoxyCodeLine{00022\ \textcolor{comment}{\ \ *\ \(\backslash\)code\ Vector3f\ ea\ =\ mat.eulerAngles(2,\ 0,\ 2);\ \(\backslash\)endcode}}
\DoxyCodeLine{00023\ \textcolor{comment}{\ \ *\ "{}2"{}\ represents\ the\ z\ axis\ and\ "{}0"{}\ the\ x\ axis,\ etc.\ The\ returned\ angles\ are\ such\ that}}
\DoxyCodeLine{00024\ \textcolor{comment}{\ \ *\ we\ have\ the\ following\ equality:}}
\DoxyCodeLine{00025\ \textcolor{comment}{\ \ *\ \(\backslash\)code}}
\DoxyCodeLine{00026\ \textcolor{comment}{\ \ *\ mat\ ==\ AngleAxisf(ea[0],\ Vector3f::UnitZ())}}
\DoxyCodeLine{00027\ \textcolor{comment}{\ \ *\ \ \ \ \ \ *\ AngleAxisf(ea[1],\ Vector3f::UnitX())}}
\DoxyCodeLine{00028\ \textcolor{comment}{\ \ *\ \ \ \ \ \ *\ AngleAxisf(ea[2],\ Vector3f::UnitZ());\ \(\backslash\)endcode}}
\DoxyCodeLine{00029\ \textcolor{comment}{\ \ *\ This\ corresponds\ to\ the\ right-\/multiply\ conventions\ (with\ right\ hand\ side\ frames).}}
\DoxyCodeLine{00030\ \textcolor{comment}{\ \ *\ }}
\DoxyCodeLine{00031\ \textcolor{comment}{\ \ *\ The\ returned\ angles\ are\ in\ the\ ranges\ [0:pi]x[-\/pi:pi]x[-\/pi:pi].}}
\DoxyCodeLine{00032\ \textcolor{comment}{\ \ *\ }}
\DoxyCodeLine{00033\ \textcolor{comment}{\ \ *\ \(\backslash\)sa\ class\ AngleAxis}}
\DoxyCodeLine{00034\ \textcolor{comment}{\ \ */}}
\DoxyCodeLine{00035\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Derived>}
\DoxyCodeLine{00036\ EIGEN\_DEVICE\_FUNC\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classEigen_1_1Matrix}{Matrix<typename\ MatrixBase<Derived>::Scalar}},3,1>}
...
\DoxyCodeLine{00039\ \ \ EIGEN\_USING\_STD(atan2)}
\DoxyCodeLine{00040\ \ \ EIGEN\_USING\_STD(sin)}
\DoxyCodeLine{00041\ \ \ EIGEN\_USING\_STD(cos)}
...
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00045\ \ \ \mbox{\hyperlink{classEigen_1_1Matrix}{Matrix<Scalar,3,1>}}\ res;}
\DoxyCodeLine{00046\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classEigen_1_1Matrix}{Matrix<typename\ Derived::Scalar,2,1>}}\ Vector2;}
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ odd\ =\ ((a0+1)\%3\ ==\ a1)\ ?\ 0\ :\ 1;}
\DoxyCodeLine{00049\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ a0;}
\DoxyCodeLine{00050\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ (a0\ +\ 1\ +\ odd)\%3;}
\DoxyCodeLine{00051\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ k\ =\ (a0\ +\ 2\ -\/\ odd)\%3;}
\DoxyCodeLine{00052\ \ \ }
