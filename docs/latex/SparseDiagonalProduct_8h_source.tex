...
\hypertarget{SparseDiagonalProduct_8h_source}{}\label{SparseDiagonalProduct_8h_source}\index{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseCore/SparseDiagonalProduct.h@{nuli-\/avionics-\/flight-\/software/platformio\_nuli\_avionics\_flight\_software/include/Eigen/src/SparseCore/SparseDiagonalProduct.h}}
...
\DoxyCodeLine{00038\ \textcolor{keyword}{struct\ }product\_evaluator<\mbox{\hyperlink{classEigen_1_1Product}{Product}}<Lhs,\ Rhs,\ DefaultProduct>,\ ProductTag,\ \mbox{\hyperlink{structEigen_1_1DiagonalShape}{DiagonalShape}},\ \mbox{\hyperlink{structEigen_1_1SparseShape}{SparseShape}}>}
...
\DoxyCodeLine{00040\ \{}
\DoxyCodeLine{00041\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classEigen_1_1Product}{Product<Lhs,\ Rhs,\ DefaultProduct>}}\ XprType;}
...
\DoxyCodeLine{00043\ \ \ }
\DoxyCodeLine{00044\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{structEigen_1_1internal_1_1sparse__diagonal__product__evaluator}{sparse\_diagonal\_product\_evaluator<Rhs,\ typename\ Lhs::DiagonalVectorType,\ Rhs::Flags\&RowMajorBit?SDP\_AsScalarProduct:SDP\_AsCwiseProduct>}}\ Base;}
\DoxyCodeLine{00045\ \ \ \textcolor{keyword}{explicit}\ product\_evaluator(\textcolor{keyword}{const}\ XprType\&\ xpr)\ :\ Base(xpr.rhs(),\ xpr.lhs().diagonal())\ \{\}}
\DoxyCodeLine{00046\ \};}
\DoxyCodeLine{00047\ }
...
\DoxyCodeLine{00049\ \textcolor{keyword}{struct\ }product\_evaluator<\mbox{\hyperlink{classEigen_1_1Product}{Product}}<Lhs,\ Rhs,\ DefaultProduct>,\ ProductTag,\ \mbox{\hyperlink{structEigen_1_1SparseShape}{SparseShape}},\ \mbox{\hyperlink{structEigen_1_1DiagonalShape}{DiagonalShape}}>}
...
\DoxyCodeLine{00051\ \{}
\DoxyCodeLine{00052\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classEigen_1_1Product}{Product<Lhs,\ Rhs,\ DefaultProduct>}}\ XprType;}
...
\DoxyCodeLine{00054\ \ \ }
\DoxyCodeLine{00055\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{structEigen_1_1internal_1_1sparse__diagonal__product__evaluator}{sparse\_diagonal\_product\_evaluator<Lhs,\ Transpose<const\ typename\ Rhs::DiagonalVectorType>}},\ Lhs::Flags\&\mbox{\hyperlink{group__flags_gae4f56c2a60bbe4bd2e44c5b19cbe8762}{RowMajorBit}}?SDP\_AsCwiseProduct:SDP\_AsScalarProduct>\ Base;}
\DoxyCodeLine{00056\ \ \ \textcolor{keyword}{explicit}\ product\_evaluator(\textcolor{keyword}{const}\ XprType\&\ xpr)\ :\ Base(xpr.lhs(),\ xpr.rhs().diagonal().transpose())\ \{\}}
\DoxyCodeLine{00057\ \};}
\DoxyCodeLine{00058\ }
...
\DoxyCodeLine{00060\ \textcolor{keyword}{struct\ }sparse\_diagonal\_product\_evaluator<SparseXprType,\ DiagonalCoeffType,\ SDP\_AsScalarProduct>}
\DoxyCodeLine{00061\ \{}
\DoxyCodeLine{00062\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00063\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{evaluator<SparseXprType>::InnerIterator}}\ SparseXprInnerIterator;}
...
\DoxyCodeLine{00067\ \ \ \textcolor{keyword}{class\ }InnerIterator\ :\ \textcolor{keyword}{public}\ SparseXprInnerIterator}
\DoxyCodeLine{00068\ \ \ \{}
\DoxyCodeLine{00069\ \ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00070\ \ \ \ \ InnerIterator(\textcolor{keyword}{const}\ sparse\_diagonal\_product\_evaluator\ \&xprEval,\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ outer)}
...
\DoxyCodeLine{00078\ \ \ \};}
\DoxyCodeLine{00079\ \ \ }
\DoxyCodeLine{00080\ \ \ sparse\_diagonal\_product\_evaluator(\textcolor{keyword}{const}\ SparseXprType\ \&sparseXpr,\ \textcolor{keyword}{const}\ DiagonalCoeffType\ \&diagCoeff)}
\DoxyCodeLine{00081\ \ \ \ \ :\ m\_sparseXprImpl(sparseXpr),\ m\_diagCoeffImpl(diagCoeff)}
\DoxyCodeLine{00082\ \ \ \{\}}
\DoxyCodeLine{00083\ }
\DoxyCodeLine{00084\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nonZerosEstimate()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ m\_sparseXprImpl.nonZerosEstimate();\ \}}
\DoxyCodeLine{00085\ \ \ \ \ }
...
\DoxyCodeLine{00093\ \textcolor{keyword}{struct\ }sparse\_diagonal\_product\_evaluator<SparseXprType,\ DiagCoeffType,\ SDP\_AsCwiseProduct>}
\DoxyCodeLine{00094\ \{}
...
\DoxyCodeLine{00099\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ SparseXprType::ColsAtCompileTime>\mbox{\hyperlink{structEigen_1_1internal_1_1packet__traits}{::type}}\ DiagCoeffNested;}
\DoxyCodeLine{00100\ \ \ }
\DoxyCodeLine{00101\ \ \ \textcolor{keyword}{class\ }InnerIterator}
\DoxyCodeLine{00102\ \ \ \{}
\DoxyCodeLine{00103\ \ \ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1evaluator}{evaluator<SparseXprType>::InnerIterator}}\ SparseXprIter;}
\DoxyCodeLine{00104\ \ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00105\ \ \ \ \ InnerIterator(\textcolor{keyword}{const}\ sparse\_diagonal\_product\_evaluator\ \&xprEval,\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ outer)}
...
\DoxyCodeLine{00111\ \ \ \ \ \textcolor{keyword}{inline}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ outer()\textcolor{keyword}{\ const\ \ }\{\ \textcolor{keywordflow}{return}\ m\_sparseIter.outer();\ \}}
\DoxyCodeLine{00112\ \ \ \ \ \textcolor{keyword}{inline}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ col()\textcolor{keyword}{\ const\ \ \ \ }\{\ \textcolor{keywordflow}{return}\ SparseXprType::IsRowMajor\ ?\ m\_sparseIter.index()\ :\ m\_sparseIter.outer();\ \}}
\DoxyCodeLine{00113\ \ \ \ \ \textcolor{keyword}{inline}\ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ row()\textcolor{keyword}{\ const\ \ \ \ }\{\ \textcolor{keywordflow}{return}\ SparseXprType::IsRowMajor\ ?\ m\_sparseIter.outer()\ :\ m\_sparseIter.index();\ \}}
\DoxyCodeLine{00114\ \ \ \ \ }
\DoxyCodeLine{00115\ \ \ \ \ EIGEN\_STRONG\_INLINE\ InnerIterator\&\ operator++()\ \{\ ++m\_sparseIter;\ \textcolor{keywordflow}{return}\ *\textcolor{keyword}{this};\ \}}
...
\DoxyCodeLine{00120\ \ \ \ \ DiagCoeffNested\ m\_diagCoeffNested;}
\DoxyCodeLine{00121\ \ \ \};}
\DoxyCodeLine{00122\ \ \ }
\DoxyCodeLine{00123\ \ \ sparse\_diagonal\_product\_evaluator(\textcolor{keyword}{const}\ SparseXprType\ \&sparseXpr,\ \textcolor{keyword}{const}\ DiagCoeffType\ \&diagCoeff)}
\DoxyCodeLine{00124\ \ \ \ \ :\ m\_sparseXprEval(sparseXpr),\ m\_diagCoeffNested(diagCoeff)}
\DoxyCodeLine{00125\ \ \ \{\}}
\DoxyCodeLine{00126\ }
\DoxyCodeLine{00127\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ nonZerosEstimate()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ m\_sparseXprEval.nonZerosEstimate();\ \}}
\DoxyCodeLine{00128\ \ \ \ \ }
