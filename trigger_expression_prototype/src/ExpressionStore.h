#ifndef TRIGGER_EXPRESSION_PROTOTYPE_EXPRESSIONSTORE_H
#define TRIGGER_EXPRESSION_PROTOTYPE_EXPRESSIONSTORE_H
...
#endif //TRIGGER_EXPRESSION_PROTOTYPE_EXPRESSIONSTORE_H
