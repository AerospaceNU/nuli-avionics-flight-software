#ifndef TRIGGER_EXPRESSION_PROTOTYPE_EMPTYEXPRESSION_H
#define TRIGGER_EXPRESSION_PROTOTYPE_EMPTYEXPRESSION_H
...
#endif //TRIGGER_EXPRESSION_PROTOTYPE_EMPTYEXPRESSION_H
