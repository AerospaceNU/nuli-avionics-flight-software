...
DEFINE_CONFIGURATION_VARIABLE(FIRMWARE_VERSION, ConfigurationString<10>, AVIONICS_ARGUMENT_firmwareVersion, strcmp(value.str, AVIONICS_ARGUMENT_firmwareVersion) == 0);
