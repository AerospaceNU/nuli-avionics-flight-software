...
public:
     ...
     * @param debugStream stream forwarded to each flag's callback
     * @return 0 if successful
     */
    CLIReturnCode_e runFlags(DebugStream* debugStream);

    /**
     * @brief Prints help text for each FlagGroup
     * @param debugStream stream the autogenerated help text is written to
     */
    void printHelp(DebugStream* debugStream) const;
...
private:
    ...
    struct FlagGroup_s {
         ...
         */
        void runFlags(DebugStream* debugStream);
