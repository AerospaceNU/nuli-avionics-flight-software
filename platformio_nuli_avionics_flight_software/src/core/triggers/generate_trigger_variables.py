...
RocketState_s (see src/Avionics.h).

Edit VARIABLES below and re-run (`python generate_trigger_variables.py` from this folder) to add,
rename, or remove a variable. TriggerVariables.h/.cpp are generated output - don't hand-edit them,
...
HEADER_PATH = "TriggerVariables.h"
SOURCE_PATH = "TriggerVariables.cpp"
...
with open(HEADER_PATH, "w") as f:
    ...
    print("// Edit generate_trigger_variables.py (in this folder) and re-run it to regenerate.", file=f)
    print("#ifndef TRIGGERVARIABLES_H", file=f)
    print("#define TRIGGERVARIABLES_H", file=f)
    print(file=f)
    ...
    print(file=f)
    print("#endif //TRIGGERVARIABLES_H", file=f)
